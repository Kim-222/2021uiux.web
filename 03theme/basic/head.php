...
<div class="container">
        <ul class="slider">
            <li><img src="<? echo G5_THEME_URL?>/images/pc01.jpg" alt=""></li>
            <li><img src="<? echo G5_THEME_URL?>/images/pc02.jpg" alt=""></li>
            <li><img src="<? echo G5_THEME_URL?>/images/pc03.jpg" alt=""></li>
        </ul>
    </div>
<?}?>
<!-- 콘텐츠 시작 { -->
