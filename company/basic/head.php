...
<style>
  .container img{margin: 0 auto; width:100%; height: 100%;}
</style>
<div class="container">
        <ul class="slider">
            <li><img src="<? echo G5_THEME_URL?>/img/main.jpg" alt=""></li>
            <li><img src="<? echo G5_THEME_URL?>/img/main2.jpg" alt=""></li>
            <li><img src="<? echo G5_THEME_URL?>/img/main4.jpg" alt=""></li>
        </ul>
    </div>
<?}?>
<!-- 콘텐츠 시작 { -->
